<?php get_header(); ?>
	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div class="post" id="post-<?php the_ID(); ?>">
				...
				<p class="meta meta-top"><small>Posted by <?php the_author(); ?> <?php edit_post_link('Edit', ' | ', ''); ?>. <!--Filed under <?php //the_category(', ') ?> |--> <?php comments_popup_link('No Comments', '1 Comment', '% Comments', 'comments'); ?></small></p>
			<div class="entry">
